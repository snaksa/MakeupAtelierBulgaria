...
<div id="alerts">
    <h4 class="alert_info">Редактиране на новина</h4>
</div>
    ...
    <article class="module width_full" style="float:left;">
        ...
        <div class="module_content">
            <fieldset>
                ...
                <input type="text" id="newsTitle" name="newsTitle" value="<?php echo $data["singleNews"]->news_title; ?>">
            </fieldset>

            <fieldset style="width: 25%;float:left;">
                <label>Автор</label>
                <input type="text" id="newsAuthor" name="newsAuthor" value="<?php echo $data["singleNews"]->news_author; ?>">
            </fieldset>
            ...
            <article class="module width_full" style="float:left;">
                ...
                <div class="module_content">
                    <div>
                        <textarea type="text" name="newsText" id="productDescription">
                            <?php echo $data["singleNews"]->news_text; ?>
                        </textarea>
                    </div>
                </div>
            </article>
        ...
        <footer>
            <div class="submit_link">
                <input type="submit" value="Редактирай новина" class="alt_btn" onclick=" return CheckFields();">
            </div>
        </footer>
    </article>
</form>
