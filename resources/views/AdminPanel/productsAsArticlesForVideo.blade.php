...
foreach ($data["products"] as $product) {
    ...
    <article class = "module width_product" style = "width: 30%;">
        <header>
            ...
            <input type = "submit" id="<?php echo $product->product_id; ?>" onclick="UpdateVideoField(this.id);return false;"  class = "alt_btn" style = "float: right;margin-top:5px;" value = "Избери"/>
        </header>
